# Curated list of free software for macOS

A curated list of free everyday software tools for macOS (files, documents, photos, video, system, network, backup, graphics, 3D, CAD, games, etc). Most of the programs are open-source, some are proprietary but free.

## Popular free/open-source utilities

- [7-Zip (CLI)](https://7-zip.org/download.html) – the command-line version of the powerful open-source file archiver.

- [Activity Monitor](https://support.apple.com/guide/activity-monitor/welcome/mac) – native system utility for monitoring processes and resource usage.

- [Affinity Studio](https://www.affinity.studio/) – professional design suite; free with account or one-time purchase.

- [Alfred](https://www.alfredapp.com/) or [Raycast](https://www.raycast.com/) – powerful productivity launchers and Spotlight replacements.
...
- [Balena Etcher](https://etcher.balena.io/) – free utility to flash OS images to SD cards & USB drives.

- [Bartender](https://www.macbartender.com/) or [Hidden Bar](https://github.com/dwarvesf/hidden) – tools to organize and hide menu bar icons.
...
- [ClamXAV](https://www.clamxav.com/) – a trusted antivirus solution for macOS based on the ClamAV engine.

- [Clementine](https://www.clementine-player.org/) – free and open-source multiplatform music player.

- [Commander One](https://mac.eltima.com/file-manager.html) – dual-pane file manager for advanced file manipulation.

- [Darktable](https://www.darktable.org/) and [DigiKam](https://www.digikam.org/) – free and open-source photography workflow and RAW editing applications.

- [Davinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve) or [Shotcut](https://www.shotcut.org/) – free and versatile video editors.

- [Disk Drill](https://www.cleverfiles.com/) – recovery tool for retrieving deleted files from Mac drives.

- [Disk Utility](https://support.apple.com/guide/disk-utility/welcome/mac) – native tool for managing disks, partitions, and mounting images.

- [DiskImageMounter](https://www.google.com/search?q=https://support.apple.com/guide/mac-help/mount-disk-images-mchlp1144/mac) – native utility to mount `.dmg` and `.iso` files.

- [Double Commander](https://doublecmd.sourceforge.io/) – free and open-source cross-platform file manager with two panels.

- [Draw.io Desktop](https://github.com/jgraph/drawio-desktop) – free and open-source diagramming app.

- [DriveDx](https://binaryfruit.com/drivedx) – advanced drive health (S.M.A.R.T.) monitoring and diagnostic tool.

- [ExifFixer](https://exiffixer.com/) – free tool that sets the correct metadata for panoramic and 360 degree photos.

- [Firefox](https://www.firefox.com/) – free and open-source web browser with a focus on privacy and customization.
...
- [Fre:ac](https://www.freac.org/) – free and open-source tool to convert audio CDs and digital files.
...
- [Git](https://git-scm.com/) – world-standard source code version control system, free.

- [Godot](https://godotengine.org/) – free and open-source game engine for 2D and 3D development.

- [GrandPerspective](https://grandperspectiv.sourceforge.net/) – free utility to visualize disk usage via a tree map.

- [Handbrake](https://handbrake.fr/) – free and open-source tool for transcoding video.

- [Hex Fiend](https://hexfiend.com/) – fast and open-source hex editor for macOS.

- [Homebrew](https://brew.sh/) – the essential "missing package manager" for macOS command-line tools.

- [Hugin](https://hugin.sourceforge.io/) – free and easy to use panoramic imaging toolchain.

- [IINA](https://iina.io/) – modern, native media player for macOS with a sleek interface.

- [Inkscape](https://inkscape.org/) – free and open-source vector graphics editor.

- [iPerf3](https://iperf.fr/iperf-download.php) – free network speed and bandwidth testing tool.

- [iStat Menus](https://bjango.com/mac/istatmenus/) – advanced system monitor that lives in the macOS menu bar.

- [JDownloader](https://jdownloader.org/) or [FDM](https://www.freedownloadmanager.org/) – free managers for large and multi-part downloads.

- [Jellyfin](https://jellyfin.org/) – free and open-source media server and player.
...
- [JMeter](https://jmeter.apache.org/) – free and open-source website load and performance tester.

- [Keka](https://www.keka.io/) – powerful, easy-to-use file archiver for macOS.

- [KiCad](https://www.kicad.org/) – free and open-source PCB design and schematic suite.

- [Kid3](https://kid3.kde.org/) – free audio tagger to manage music file metadata.

- [Kiwix](https://kiwix.org/en/) – free and open-source offline reader for websites and Wikipedia.

- [Krita](https://krita.org/en/) – free and open-source digital painting and illustration program.

- [Lazarus](https://www.lazarus-ide.org/) – free and open-source Delphi/Pascal development environment.

- [LibreOffice](https://www.libreoffice.org/) – free and open-source office productivity suite.

- [Librewolf](https://librewolf.net/) – a fork of Firefox focused on privacy, security, and user freedom; free.

- [LMMS](https://lmms.io/) – free and open-source digital audio workstation (DAW).
...
- [Mixxx](https://mixxx.org/) – free and open-source software for professional DJing.

- [MusicBrainz Picard](https://picard.musicbrainz.org/) – cross-platform music tagger powered by the MusicBrainz database.

- [NMap](https://nmap.org/) – free and open-source network mapper and security scanner.

- [Notepad++](https://notepad-plus-plus-mac.org/), [NotepadNext](https://github.com/dail8859/NotepadNext) – open-source alternatives to Notepad++ for macOS.
...
- [Packages](https://www.google.com/search?q=http://s.alan-quatermain.me/packages) – free tool to create installation packages for macOS.

- [Pinta](https://www.google.com/search?q=https://pinta-project.com/pintaproject/pinta/) – free, easy-to-use drawing and image editing program.

- [Preview](https://support.apple.com/guide/preview/welcome/mac) – native universal viewer for PDFs, images, and basic document editing. 
...
- [PyCharm](https://www.jetbrains.com/pycharm/download/) or [Thonny](https://thonny.org/) – free Python IDEs for beginners and professionals.

- [Qbittorrent](https://www.qbittorrent.org/) and [Transmission](https://transmissionbt.com/download) – free and open-source BitTorrent clients.
...
- [Sublime Text](https://www.sublimetext.com/) – sophisticated text editor for code and prose; free evaluation.

- [Sweet Home 3D](http://www.sweethome3d.com/) – free and open-source architectural design software.

- [Thunderbird](https://www.thunderbird.net/en-US/) – free and open-source email, calendar, and chat client.
...
- [Time Machine](https://support.apple.com/en-us/HT201250) – native, automatic backup solution for macOS.
...
- [YACReader](https://www.yacreader.com/) – free and open-source comic book reader and library manager.

- [yt-dlp](https://github.com/yt-dlp/yt-dlp) – free and open-source command-line audio/video downloader.
